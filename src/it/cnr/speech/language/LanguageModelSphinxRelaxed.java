...
public class LanguageModelSphinxRelaxed extends LanguageModel {

	public static void main(String[] args) throws Exception {
		File model = new File(
				"D:\\WorkFolder\\Experiments\\Speech Recognition Speecon\\Speecon connected digits\\language model\\conndigits.lm");
		LanguageModelSphinxRelaxed lms = new LanguageModelSphinxRelaxed(model);
		System.out.println("Model loaded\n"+Arrays.toString(lms.getAllWords()));
	}

	public LanguageModelSphinxRelaxed(File sphinxLM) throws Exception {
