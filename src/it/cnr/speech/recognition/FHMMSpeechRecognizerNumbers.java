...
public class FHMMSpeechRecognizerNumbers {
	...
	public static void main(String[] args) throws Exception {
		...
		for (File sampleFile : allWaveFiles) {
			...
			if (sampleFile.getName().endsWith(".wav")) {
				FHMMSpeechRecognizerNumbers asr = new FHMMSpeechRecognizerNumbers();
				String recognized = asr.recognize(sampleFile);
				File output = new File(sampleFile.getAbsolutePath().replace(".wav", "_fhmm_transcr.txt"));
