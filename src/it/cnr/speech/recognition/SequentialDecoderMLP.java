...
public class SequentialDecoderMLP {
	public int nMaxSyl = 3;
	public double threshold = 0.99 + 1;
	...
	public static void main(String[] args) throws Exception {
		...
		File[] files = new File("/home/gp/Desktop/ASR/Wave_Cifre_Isolate_4_DL/").listFiles();
		...
		//File f1 = new File("/home/gp/Desktop/ASR/Wave_Cifre_Isolate_4_DL/SA020CI3.wav");
		...
		for (File f : files) {
			...
			if (f.getName().endsWith(".wav")) {
				...
				SequentialDecoderMLP decoder = new SequentialDecoderMLP();

				System.out.println("Adding lm");
				decoder.addLanguageModel(lm);

				for (String word : allWords) {
					if (word.equals("u") || word.equals("no") || word.equals("due") || word.equals("tre")
							|| word.equals("kwa") || word.equals("ttro") || word.equals("tSin") || word.equals("kwe")
							|| word.equals("sei") || word.equals("se") || word.equals("tte") || word.equals("o")
							|| word.equals("tto") || word.equals("dze") || word.equals("ro")
							// || word.equals("no") || word.equals("ve")
							|| word.equals("sil") || word.equals("sp")) {
						System.out.println("Adding word " + word);

						AcousticModelMLPForSequentialRecognition m = new AcousticModelMLPForSequentialRecognition(word);
