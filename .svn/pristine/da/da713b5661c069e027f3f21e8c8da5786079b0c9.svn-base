...
public class AcousticModelLSTMForSequentialRecognition extends AcousticModel{

	public AcousticModelLSTMForSequentialRecognition(String modelName) {
		super(modelName);		
	}
	
	public static File model = new File("/home/gp/Desktop/ASR/deeplearning/LSTM/lstm_h-1000_out_channels-128_lr-001_ba-256_opt-adam_bd-False_dp-0.5/best_model.pth");
