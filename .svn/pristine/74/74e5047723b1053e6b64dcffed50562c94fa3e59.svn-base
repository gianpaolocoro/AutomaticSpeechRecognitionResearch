...
public class AcousticModelMLP extends AcousticModel{

	public AcousticModelMLP(String modelName) {
		super(modelName);		
	}
	...
	public static void main(String[] args) throws Exception{
		...
		AcousticModelMLP a1 = new AcousticModelMLP("ttro");
		double d = a1.calcLikelihood(mfccMatrix);
		System.out.println("Score ttro "+d);
		AcousticModelMLP a2 = new AcousticModelMLP("di");
